    ...
    <el-main class="fm2-main">
      <el-container>
        ...
        <el-aside class="widget-config-container">
          <el-container>
            ...
            <el-main class="config-content">
              <widget-config v-show="configTab=='widget'" :data="widgetFormSelect" @mirror="showMirror"></widget-config>
        ...
        <cus-dialog
          ...
          form
        >
          <generate-form insite="true" @input-enter="inputChange" @on-change="handleDataChange" v-if="previewVisible" :data="widgetForm" :value="widgetModels" :remote="remoteFuncs" ref="generateForm">
...
export default {
  ...
  props: {
    ...
    bankingFields:{
        type: Array,
        default: () => ['password','againpassword',"amount","input","singletext","textarea","radio","checkbox","time","date","select","idencard","readcard"]
    },
    basicFields: {
      type: Array,
