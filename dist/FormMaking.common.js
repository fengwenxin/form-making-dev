module.exports = (function(t) {
            ...
            render: function(t) {
              ...
              var n = (function(t, e, n) {
                  var i = 0,
                    o = 0,
                    r = S(e, n, "header");
                  r && ((i = r.length), (t = t ? [].concat(v(r), v(t)) : v(r)));
                  var a = S(e, n, "footer");
                  return (
                    a &&
                      ((o = a.length), (t = t ? [].concat(v(t), v(a)) : v(a))),
              ...
              if (
                ((this.noneFunctionalComponentMode =
                  this.getTag().toLowerCase() !==
                    this.$el.nodeName.toLowerCase() && !this.getIsFunctional()),
  ...
  "387f": function(t, e, n) {
    ...
    t.exports = function(t, e, n, i, o) {
      return (
        (t.config = e), n && (t.code = n), (t.request = i), (t.response = o), t
      );
    };
  },
  "38fd": function(t, e, n) {
  ...
  "53fe": function(t, e, n) {
     ...
     */ !(function(r) {
      "use strict";
      void 0 === (o = "function" == typeof (i = r) ? i.call(e, n, e, t) : i) ||
        (t.exports = o);
    })(function() {
      "use strict";
          ...
          do {
            if (
              ...
              if (
                ...
                if (!n || !n.getBoundingClientRect || n === U.body) return st();
                if (i || e) return n;
                i = !0;
              }
            }
          ...
          if (e.scroll) {
            ...
            do {
              ...
              if (
                ...
                (y =
                  x && (et(I - u) <= r && S + A < g) - (et(D - u) <= r && !!S)),
                (_ =
                  k && (et(M - d) <= r && O + L < v) - (et(T - d) <= r && !!O)),
                !j[h])
              )
      ...
      function vt(t, e) {
        ...
        var n = {
          ...
          supportPointer: !1 !== vt.supportPointer && "PointerEvent" in window,
      ...
      function zt(t, e, n, i) {
        if (t.getBoundingClientRect || t === $) {
          ...
          return { top: r, left: a, bottom: s, right: l, width: u, height: c };
        }
      }
      function Vt(t, e) {
      ...
      return (
        (vt.prototype = {
          ...
          _emulateDragOver: function(e) {
            if (w) {
              if (this._lastX === w.clientX && this._lastY === w.clientY && !e)
                return;
              ...
              for (
                ...
                n &&
                n.shadowRoot &&
                (n = n.shadowRoot.elementFromPoint(w.clientX, w.clientY)) !== i;
          ...
          _onTouchMove: function(t, e) {
            if (y) {
              ...
              if (!vt.active && !T) {
                if (
                  o &&
                  nt(et(a.clientX - this._lastX), et(a.clientY - this._lastY)) <
                    o
                )
                  return;
          ...
          _onDragStart: function(e, n) {
            ...
            ((i = $t(t)).draggable = !1),
              ...
              n
                ? ((M = !0), (r._loopId = setInterval(r._emulateDragOver, 50)))
            ...
            function q(e) {
              return (
                e &&
                  ...
                  g &&
                    (xt(t, m ? m.options.ghostClass : g.options.ghostClass, !1),
                    xt(t, d.ghostClass, !0)),
                  m !== y && y !== vt.active
                    ? (m = y)
                    : y === vt.active && (m = null),
            ...
            (T = !1),
              ...
              a &&
                ...
                t &&
                  ...
                  jt(t),
                  (t.style["will-change"] = ""),
                  xt(t, m ? m.options.ghostClass : this.options.ghostClass, !1),
                ...
                ? [
                    n("el-time-picker", {
                      ...
                      attrs: {
                        ...
                        placeholder: t.widget.options.placeholder,
                        "start-placeholder": t.widget.options.startPlaceholder,
      ...
      return new Promise(function(e, c) {
        ...
        if (
          ...
          (f.ontimeout = function() {
            c(
              l("timeout of " + t.timeout + "ms exceeded", t, "ECONNABORTED", f)
            ),
              (f = null);
          }),
                        ...
                        : n(
                            ...
                            [
                              n("i", {
                                ...
                                style: { "font-size": t.miniWidth / 8 + "px" },
                              ...
                              t.isDelete && t.fileList.length > t.min
                                ? n("i", {
                                    ...
                                    attrs: { title: t.$t("fm.upload.delete") },
                                    on: {
                                      click: function(n) {
    ...
    t.exports = (function() {
      ...
      var tt = (function() {
        ...
        if (i) {
          ...
          o.addEventListener("test", n, r), o.removeEventListener("test", n, r);
        }
        return t;
      })();
      function et(t, e, n) {
      ...
      function st(t, e) {
        ...
        if (t.naturalWidth && !at) return e(t.naturalWidth, t.naturalHeight), n;
        ...
        ft = {
          bind: function() {
            ...
            nt(e, "click", (this.onClick = this.click.bind(this))),
              ...
              t.toggleOnDblclick &&
                nt(n, "dblclick", (this.onDblclick = this.dblclick.bind(this)));
          },
          unbind: function() {
            var t = this.options,
              e = this.viewer,
        ...
        pt = {
          ...
          dblclick: function(t) {
            t.preventDefault(),
              this.viewed &&
                t.target === this.image &&
                (r && t.isTrusted && clearTimeout(this.doubleClickImageTimeout),
                this.toggle());
          },
          load: function() {
            var t = this;
                  ...
                  if (!this.ready) {
                    ...
                    if (
                      ...
                      e.backdrop &&
                        ...
                        e.inline || "static" === e.backdrop || Z(h, T, "hide")),
                      I(e.className) &&
                        e.className &&
          ...
          (e.isChunkExpired = o),
            ...
            (e.createMkFileUrl = function(t, e, n, i) {
              ...
              null != n && (o += "/key/" + (0, v.urlSafeBase64Encode)(n)),
                i.mimeType &&
                  (o += "/mimeType/" + (0, v.urlSafeBase64Encode)(i.mimeType));
              var a = i.fname;
              return (
          ...
          e.UploadManager = (function() {
            ...
            return (
                  ...
                  return (
                    e.then(
                      ...
                      function(e) {
                        if (
                          (t.clear(),
                          e.isRequestError && !t.config.disableStatisticsReport)
                        ) {
              ...
              (t.prototype.notifyResumeProgress = function() {
                ...
                (this.progress = {
                  total: this.getProgressInfoItem(
                    (0, s.sum)(this.loaded.chunks) + this.loaded.mkFileProgress,
                    this.file.size + 1
                  ),
          ...
          var i = n(0),
            ...
            J = function(t, e) {
              if (
                ...
                var n = j(t, e);
                return (
                  !n || !o($, e) || (o(t, A) && t[A][e]) || (n.enumerable = !0),
                  n
                );
              }
            },
                    ...
                    ? this.getOriginImage()
                        ...
                        .then(function(n) {
                          ...
                          return i.size > t.file.size &&
                            ...
                            ? { dist: t.file, width: e.width, height: e.height }
            ...
            function c(t, e, n, i, o) {
              ...
              switch (f) {
                ...
                case 10:
                  ...
                  for (a = [], l = 0; l < p; l++)
                    a[l] =
                      t.getInt32(h + 8 * l, !o) / t.getInt32(h + 4 + 8 * l, !o);
                  return a;
              }
            }
            function u(t, e, i) {
                      ...
                      case 6:
                        if (r.JpegIFOffset && r.JpegIFByteCount) {
                          var a = e + r.JpegIFOffset,
                            s = r.JpegIFByteCount;
                          r.blob = new Blob([new Uint8Array(t.buffer, a, s)], {
                            type: "image/jpeg",
                          });
                        }
                    }
                    ...
                    [
                      "grid" != t.data.type
                        ? n(
                            "el-form-item",
                            {
                              attrs: { label: t.$t("fm.config.widget.model") },
                            },
                            [
                              n("el-input", {
                                model: {
                      ...
                      Object.keys(t.data.options).indexOf("width") >= 0
                        ? n(
                            "el-form-item",
                            {
                              attrs: { label: t.$t("fm.config.widget.width") },
                            },
                            [
                              n("el-input", {
                                model: {
                      ...
                      Object.keys(t.data.options).indexOf("height") >= 0
                        ? n(
                            "el-form-item",
                            {
                              attrs: { label: t.$t("fm.config.widget.height") },
                            },
                            [
                              n("el-input", {
                                model: {
                      ...
                      Object.keys(t.data.options).indexOf("size") >= 0
                        ...
                        : t._e(),
                      Object.keys(t.data.options).indexOf("placeholder") >= 0 &&
                      ...
                      Object.keys(t.data.options).indexOf("inline") >= 0
                        ? n(
                            "el-form-item",
                            {
                              attrs: { label: t.$t("fm.config.widget.layout") },
                            },
                            [
                              n(
                                "el-radio-group",
                                ...
                                [
                                  n(
                                    "el-radio-button",
                                    { attrs: { label: !1 } },
                                    [t._v(t._s(t.$t("fm.config.widget.block")))]
                                  ),
                                  n(
                                    "el-radio-button",
                                    { attrs: { label: !0 } },
                      ...
                      Object.keys(t.data.options).indexOf("options") >= 0
                        ? n(
                            "el-form-item",
                            {
                              attrs: { label: t.$t("fm.config.widget.option") },
                            },
                            [
                              n(
                                "el-radio-group",
                                  ...
                                  n(
                                    ...
                                    [
                                      n("template", { slot: "prepend" }, [
                                        t._v(
                                          t._s(
                                            t.$t("fm.config.widget.remoteFunc")
                                          )
                                        ),
                                      ]),
                                    ],
                        ...
                        ? [
                            "date" == t.data.type
                              ? n(
                                  ...
                                  {
                                    attrs: {
                                      label: t.$t("fm.config.widget.showType"),
                                    },
                                  },
                                  [
                                    n(
                            ...
                            "daterange" == t.data.options.type
                              ? n(
                                  ...
                                  [
                                    n("el-input", {
                                      model: {
                                        value: t.data.options.startPlaceholder,
                                        callback: function(e) {
                                          t.$set(
                                            t.data.options,
                                            "startPlaceholder",
                            ...
                            "time" == t.data.type &&
                            Object.keys(t.data.options).indexOf("isRange") >= 0
                              ? n(
                                  "el-form-item",
                                  {
                                    attrs: {
                              ...
                              [
                                n("el-input", {
                                  ...
                                  model: {
                                    ...
                                    callback: function(e) {
                                      t.$set(t.data.options, "length", t._n(e));
                                    },
                                ...
                                n(
                                  ...
                                  [
                                    n("el-option", {
                                      attrs: {
                                        value: "String",
                                        label: t.$t("fm.config.widget.string"),
                                      },
                                    }),
                                    n("el-option", {
                                      attrs: {
                                        value: "Object",
                                        label: t.$t("fm.config.widget.object"),
                                      },
                                    }),
                                    n("el-option", {
                                      attrs: {
                      ...
                      "grid" == t.data.type
                        ? [
                            ...
                            n(
                              ...
                              {
                                attrs: {
                                  label: t.$t("fm.config.widget.columnOption"),
                                },
                              },
                              [
                                n(
                                ...
                                n(
                                  ...
                                  [
                                    n(
                                      ...
                                      [t._v(t._s(t.$t("fm.actions.addColumn")))]
                                    ),
                                  ],
                                  1
                                ),
                            ...
                            n(
                              ...
                              [
                                ...
                                Object.keys(t.data.options).indexOf(
                                  ...
                                  : t._e(),
                                Object.keys(t.data.options).indexOf("isEdit") >=
                                0
                                  ? n(
                                      "el-checkbox",
                                      {
                                      ...
                                      [
                                        t._v(
                                          t._s(t.$t("fm.config.widget.isEdit"))
                                        ),
                                      ]
                                    )
                                  : t._e(),
                                  ...
                                  ? n(
                                      ...
                                      [
                                        ...
                                        n("el-option", {
                                          attrs: {
                                            value: "url",
                                            label: t.$t("fm.config.widget.url"),
                                          },
                                        }),
                                        n("el-option", {
                                          attrs: {
                    ...
                    [
                      n(
                        ...
                        [
                          ...
                          n("el-radio-button", { attrs: { label: "right" } }, [
                            t._v(
                              t._s(t.$t("fm.config.form.labelPosition.right"))
                            ),
                          ]),
                  ...
                  n(
                    ...
                    [
                      n(
                        ...
                        [
                          n("el-radio-button", { attrs: { label: "medium" } }, [
                            t._v("medium"),
                          ]),
                          n("el-radio-button", { attrs: { label: "small" } }, [
                            t._v("small"),
                          ]),
            ...
            ? n(
                ...
                [
                    ...
                    ? [
                        n("el-time-picker", {
                          ...
                          attrs: {
                            ...
                            "end-placeholder": t.element.options.endPlaceholder,
                  ...
                  "blank" == t.element.type
                    ...
                    : t._e(),
                  "text" == t.element.type
                    ? [n("span", [t._v(t._s(t.element.options.defaultValue))])]
                    : t._e(),
    ...
    var $,
      ...
      N = {
        ...
        methods: {
          ...
          handleGenerateCode: function() {
            (this.codeVisible = !0),
              (this.htmlTemplate = L(JSON.stringify(this.widgetForm), "html")),
                            ...
                            [
                              t.basicFields.length
                                ? [
                                    n("div", { staticClass: "widget-cate" }, [
                                      t._v(
                                        t._s(t.$t("fm.components.basic.title"))
                                      ),
                                    ]),
                                    n(
                                      "draggable",
                                      ...
                                      t._l(t.basicComponents, function(e, i) {
                                        return t.basicFields.indexOf(e.type) >=
                                          0
                                          ? n(
                                              "li",
                                              {
                              ...
                              t.advanceFields.length
                                ? [
                                    ...
                                    n(
                                      ...
                                      t._l(t.advanceComponents, function(e, i) {
                              ...
                              t.layoutFields.length
                                ? [
                                    n("div", { staticClass: "widget-cate" }, [
                                      t._v(
                                        t._s(t.$t("fm.components.layout.title"))
                                      ),
                                    ]),
                                    n(
                                      "draggable",
                                      ...
                                      t._l(t.layoutComponents, function(e, i) {
                                        return t.layoutFields.indexOf(e.type) >=
                                          0
                                          ? n(
                                              "li",
                                              {
                        ...
                        n(
                          ...
                          [
                            ...
                            n(
                              ...
                              {
                                class: {
                                  "widget-empty": 0 == t.widgetForm.list.length,
                                },
                              },
                              [
                                t.resetJson
                              ...
                              [
                                n("el-header", { attrs: { height: "45px" } }, [
                                  n(
                                    ...
                                    [t._v(t._s(t.$t("fm.config.widget.title")))]
                                  ),
                                  n(
                                    "div",
                                    {
                                      staticClass: "config-tab",
                                      class: { active: "form" == t.configTab },
                                      on: {
                                        click: function(e) {
                                    ...
                                    [t._v(t._s(t.$t("fm.config.form.title")))]
                                  ),
                                ]),
                                n(
                                  "el-main",
      ...
      B = {
        fm: {
          ...
          message: { copySuccess: "复制成功", validError: "表单数据校验失败" },
          actions: {
            import: "导入JSON",
            clear: "清空",
            preview: "预览",
